...
import { createStore, compose } from 'redux'; //La logica que nos va ayudar para poder tener un store y compartirselo a nuestra aplicacion
...
/**
const initialState = {
    "user": {}, //Aqui vamos a traer la data inicial de un usuario
    "playing": {}, //Nos permite saber si estamos reproduciendo o no un video
    "myList": [],
    "trends": [
      {
        "id": 2,
...
const store = createStore(reducer, preloadedState, composeEnhancers()); //para poder tener referencia a nuestro store

delete window.__PRELOADED_STATE__;

ReactDOM.hydrate(
  //Estamos conectado toda la aplicacion para que pueda tener el encapsulado con la data inicial
